...
INSERT INTO employee_performance (employee_id, employee_name, department, location, performance_year, performance_month, salary, sales_amount, rating) VALUES 
...
select *, sum(sales_amount) over(partition by location order by sales_amount)
